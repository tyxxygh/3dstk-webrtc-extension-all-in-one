...
makeLinks()
{
  ...
  ##for LAN repository
  makeLink "." "chromium/src/third_party/llvm" "../chromium/third_party/dynamicDownload/llvm"
  makeLink "." "chromium/src/third_party/llvm-build" "../chromium/third_party/dynamicDownload/llvm-build"
  makeLink "." "chromium/src/third_party/libjingle" "../chromium/third_party/dynamicDownload/libjingle"
  ##end
...
setupDepotTools
#preset gn and clang-format binary when in local reposity to avoid downloading.
#downloadGnBinaries
